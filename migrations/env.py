"""Alembic migration environment — async, reads DATABASE_URL from the environment."""
import asyncio
import os
import sys
...
from core import Base, settings  # noqa: E402
...
# DATABASE_URL always wins over alembic.ini
